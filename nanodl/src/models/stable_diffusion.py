...
diffusion_model = StableDiffusionModel(image_size, widths, block_depth)
...
image_generator = StableDiffusionImageGenerator(diffusion_model, params)
...
trainer = StableDiffusionDataParallelTrainer(diffusion_model, images.shape, 'params.pkl')
...
class StableDiffusionModel(nn.Module):
    """
    Image Generating StableStableDiffusion Model.
...
class StableDiffusionImageGenerator:
    def __init__(self, 
                 ...
                 params: Any):
        """
        Initializes the StableDiffusionImageGenerator with a diffusion model and its parameters.

        Args:
            diffusion_model (StableDiffusionModel): An instance of the StableDiffusionModel.
            params (Any): The parameters (weights) of the StableDiffusionModel.
        """
...
class StableDiffusionDataParallelTrainer:
    """
    ...
    def __init__(self, 
        ...
        self.train_step = jax.pmap(StableDiffusionDataParallelTrainer.train_step, axis_name='devices')
        self.evaluation_step = jax.pmap(StableDiffusionDataParallelTrainer.evaluation_step, axis_name='devices')
